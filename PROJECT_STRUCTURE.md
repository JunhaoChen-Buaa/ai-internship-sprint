...
- `app/api/competitive/analyze/`: Vercel-compatible multi-agent demo route. It calls MiniMax through separate Scope, Collection, Analysis, Writing, and QA steps.
...
- The competitive-analysis UI can run a Vercel-compatible multi-agent MiniMax pipeline.
